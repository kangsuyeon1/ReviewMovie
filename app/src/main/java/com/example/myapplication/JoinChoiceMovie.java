...
public class JoinChoiceMovie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JoinChoiceMovie.MyGridAdapter gAdapter = new JoinChoiceMovie.MyGridAdapter(this);
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            iv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    View dialogView = View.inflate(JoinChoiceMovie.this, R.layout.dialog, null);
                    AlertDialog.Builder dlg = new AlertDialog.Builder(JoinChoiceMovie.this);
